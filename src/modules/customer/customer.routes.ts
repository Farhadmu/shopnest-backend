...
import * as spendingAnalyticsCtrl from "./spending-analytics.controller";
import * as activityTimelineCtrl from "./features/activity-timeline.controller";
import * as journeyCtrl from "./features/journey.controller";
import * as budgetPlannerCtrl from "./features/budget-planner.controller";
import * as compatibilityCtrl from "./features/compatibility.controller";
...
// ============================================================
// 0. SHOPPING JOURNEY, BUDGET PLANNER, COMPATIBILITY, BUNDLE, LIFECYCLE, GOALS
...
// ============================================================
router.get("/expense-analytics", ...requireAuth, spendingAnalyticsCtrl.getComprehensiveSpendingAnalytics);

// ============================================================
// 16. INTELLIGENT NOTIFICATION CENTER (Feature 16)
// ============================================================
router.get("/notifications/intelligent", ...requireAuth, notificationCtrl.listNotifications);
router.patch("/notifications/:id/read", ...requireAuth, notificationCtrl.markRead);
router.patch("/notifications/read-all", ...requireAuth, notificationCtrl.markAllRead);
...
// ============================================================
router.get("/activity", ...requireAuth, activityTimelineCtrl.getCustomerActivityTimeline);
router.delete("/activity", ...requireAuth, activityTimelineCtrl.clearActivityTimeline);
...
router.get("/budget/tracker", ...requireAuth, spendingAnalyticsCtrl.getBudgetTracker);
router.get("/analytics/spending", ...requireAuth, spendingAnalyticsCtrl.getComprehensiveSpendingAnalytics);
